...
const SignIn: React.FC = () => {
  ...
  const toogleEye = (event: React.MouseEvent<HTMLButtonElement, MouseEvent>) => {
              ...
              <form>
                ...
                <div className="mb-6">
                  ...
                  <div className="relative">
                    ...
                    <span className="absolute right-4 top-4">
                      {/* <FaEye style={{ height: "22", width: "22" }} className="fill-current" /> */}
                      <button onClick={(e: React.MouseEvent<HTMLButtonElement, MouseEvent>) => toogleEye(e)}>
                        {eyeOpen === false ? <FaRegEye className="w-5 h-5 fill-current" /> : <FaRegEyeSlash className="w-5 h-5" />}
                      </button>
                    </span>
                  </div>
                </div>
